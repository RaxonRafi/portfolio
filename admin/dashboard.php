                ...
                <div class="col-xl-4 mg-t-20 mg-xl-t-0">
                    ...
                    <div class="card widget-messages mg-t-20">
                        ...
                        <div class="list-group list-group-flush">
                            <?php
                  foreach(panda_all('contacts') as $single_messages):
                            ?>
                            <a href="" class="list-group-item list-group-item-action media">
                               
                                <div class="media-body">
                                    <div class="msg-top">
                                        <span><?= $single_messages['First_name']?></span>
                                    </div>
                                    <p class="msg-summary"><?= $single_messages['massage'].''.$single_messages['Last_name']?></p>
                                </div><!-- media-body -->
                            </a><!-- list-group-item -->
                            <?php endforeach; ?>
