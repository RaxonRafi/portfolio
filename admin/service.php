...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
                ...
                <div class="form-layout">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group mg-b-10-force">
                            ...
                            <textarea id="service_icon_id" class="form-control" name="service_icon" rows="1"></textarea>
                            <br>
                            <?php
                            ...
                            <div style="height: 200px; overflow-y:scroll">
                                ...
                                ?>
                                    <i id="<?= $icon ?>" class=" panda_icon border p-2 fa <?= $icon ?>"></i>
                                <?php endforeach; ?>
            ...
            <hr>
            <h6 class="card-body-title">list service</h6>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $single_service['service_icon'] ?></td>

                            <td>
                                <a href="service-delete.php?id=<?= $single_service['id'] ?>" class=" text-white btn btn-sm btn-danger">
